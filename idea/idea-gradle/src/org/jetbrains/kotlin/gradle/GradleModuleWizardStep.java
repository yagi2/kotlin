...
public class GradleModuleWizardStep extends ModuleWizardStep {
  ...
  @NotNull
  private final GradleWithKotlinDSLModuleBuilder myBuilder;
  @NotNull
  ...
  public GradleModuleWizardStep(@NotNull GradleWithKotlinDSLModuleBuilder builder, @NotNull WizardContext context) {
