 ...
 */
public class GradleWithKotlinDSLModuleBuilder extends AbstractExternalModuleBuilder<GradleProjectSettings> {

  private static final Logger LOG = Logger.getInstance(GradleWithKotlinDSLModuleBuilder.class);
  ...
  public GradleWithKotlinDSLModuleBuilder() {
